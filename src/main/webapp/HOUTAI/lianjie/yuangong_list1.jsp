	...
	function update(id){
		 $.ajax({
			...
			success: function(req){
		     ...
		     $("#updateModal #userid").val(req.userid);
...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            ...
            <form role="form" action="${pageContext.request.contextPath }/admin/insertyg"  method="POST" id="addExamForm">
...
<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
            <form role="form" action="${pageContext.request.contextPath }/admin/updateyg" id="addExamForm">             
                <input type="hidden" name="id" id="id">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
