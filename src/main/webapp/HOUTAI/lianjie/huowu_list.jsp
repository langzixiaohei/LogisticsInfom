...
<script type="text/javascript">		
	...
	//得到订单号
      var goodsname=$("#goodsname").val();
		window.location=path+"/admin/getbylisthuowu?goodsname="+goodsname;
			...
			<div class="ui_text_indent">
					<div id="box_border">
						<div id="box_top">搜索</div>
							<form action="${pageContext.request.contextPath }/admin/getbylisthuowu" method="POST">
						<div id="box_center">					
						商品名称:&nbsp;&nbsp;<input type="text" id="goodsname" name="goodsname" style="height: 40px;margin-top: 10px;" class="ui_input_txt02"/>
						</div>
						<div id="box_bottom">
				...
				<div class="ui_tb">				
					<table class="table" cellspacing="0" cellpadding="0" width="100%" align="center" border="0">
						...
						<c:forEach var="good" items="${sessionScope.goodssy}">
							<tr>
								<td>${good.goodName }</td>
								<td>${good.goodStype }</td>
								<td>${good.weight }</td>							
								<td>	
									<a href="javascript:updateshow(${good.id});" class="edit">修改</a> 
									<a href="javascript:del(${good.id});" class="edit">删除</a> 					    
								</td>
							</tr>
