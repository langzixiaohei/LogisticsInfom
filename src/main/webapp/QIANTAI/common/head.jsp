...
<!-- Stats-Number-Scroller-Animation-JavaScript -->
	<script src="/QIANTAI/js/waypoints.min.js"></script>
	<script src="/QIANTAI/js/counterup.min.js"></script>
	...
	<div class="clearfix"> </div><div class="header">
		<div class="container">
			...
			<div class="w3l_header_right">
				...
				<c:otherwise>
				<ul>
					<li><a href="/QIANTAI/login.jsp"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>登陆</a></li>
					<li><a href="/QIANTAI/sign-up.jsp"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>注册</a></li>
				</ul>
				</c:otherwise>
				</c:choose>
			</div>
				...
				<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					<nav class="link-effect-2" id="link-effect-2">
						<ul class="nav navbar-nav">
							...
							<li><a href="javaScript:void(0)" onclick="tuiChu()"><span data-hover="out">退出注销</span></a></li>
						</ul>
					</nav>
				</div>
				<!-- /.navbar-collapse -->
	...
	function tuiChu() {
        $.ajax({
            ...
            success: function(data){
                if(data=="1" || data==1){
                    window.location.href='${pageContext.request.contextPath}/QIANTAI/index.jsp';
				}else {
                   alert("错了");
                }
            }
